...
http://localhost:7001/myapp/employee	[POST]
{
    "name": "Jerry",
    "sal": 28000,
    "profile": {
...
http://localhost:7001/myapp/employee	[GET]

2) One to Many relationship (Question & Answer)
A) Create new question:
http://localhost:7001/myapp/question	[POST]
{
...
http://localhost:7001/myapp/question	[GET]

3) Many to Many relationship (Student & Course)
A) Create new student:
http://localhost:7001/myapp/student		[POST]
{
    "studentName": "Jerry",
    "courses": ["Jenkins", "Spring", "Angular"]
}
B) Read all students:
http://localhost:7001/myapp/student		[GET]
